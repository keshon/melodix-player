...
rem Build command
go build -o melodix.exe -ldflags "-X github.com/keshon/melodix-player/internal/version.BuildDate=%BUILD_DATE% -X github.com/keshon/melodix-player/internal/version.GoVersion=%GO_VERSION%" cmd\melodix\melodix.go
